    ...
    window[h].prototype =
    {
        ...
        drawRect: function() {
            ...
            if (!(b = document.getElementById("imgRect")))
                b = document.createElement("canvas"), b.id = "imgRect", document.body.appendChild(b),
    ...
    window[h].module("toThresh", function(h) {
        return {
            process: function(b, a) {
                ...
                var c = b.data;
                a = a[0] || 128;
                for (var f = 0, g = c.length; f < g; f++)(f + 1)
                    %4 && (c[f] = c[f] > a ? 255 : 0);
                b.data = c;
                return b
            }
...
(function(h) {
    window[h].module("setRGB", function() {
        return {
            process: function(h, rgb) {
                for (var b = h.data, a = 0, c = b.length; a < c; a += 4) {
                    b[a + 0] *= rgb[0];
                    b[a + 1] *= rgb[1];
                    b[a + 2] *= rgb[2];
